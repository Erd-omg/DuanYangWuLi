...
public class AtmosphericScattering : MonoBehaviour {
	...
	public void OnValidate() {
		...
		worldNearScatterPush = Mathf.Clamp(worldNearScatterPush, -200f, 30000f);
		...
		heightNearScatterPush = Mathf.Clamp(heightNearScatterPush, -200f, 30000f);
...
UpdateStaticUniforms();
	...
	void UpdateDynamicUniforms() {
		...
		Shader.SetGlobalVector("u_SunDirection", hasSun ? -activeSun.transform.forward : Vector3.up);	
